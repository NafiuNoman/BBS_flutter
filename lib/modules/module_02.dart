import 'package:bbs_app/controllers/module02_controller.dart';
import 'package:bbs_app/widgets/my_check_box.dart';
import 'package:bbs_app/widgets/new_box_plus_minus_btn.dart';
...
class _Module02State extends State<Module02> {
  ...
  final Module02Controller controller = Get.put(Module02Controller());
  @override
            ...
            children: [
              Row(
                children: [
                  ...
                  const Text(' মোট কক্ষ সংখ্যা'),
                  SizedBox(
                    width: 100,
                    child:  Obx(
                        ()=> NewPlusMinusBtn(
                          addOnpressed: () {
                            controller.q8aCounter.value++;
                          },
                          minusOnpressed: () {
                            controller.q8aCounter.value--;
                          },
                          count: controller.q8aCounter.value,
                        ),
                    ),
              ...
              Row(
                children: [
                  const Text('b.',
                      style: TextStyle(
                          color: textColor, fontWeight: FontWeight.w600)),
                  const Text(' শোবার কক্ষ সংখ্যা'),
                  SizedBox(
                      width: 100,
                      child:  Obx(
                          ()=> NewPlusMinusBtn(
                            addOnpressed: () {
                              controller.q8bCounter.value++;
                            },
                            minusOnpressed: () {
                              controller.q8bCounter.value--;
                            },
                            count: controller.q8bCounter.value,
                          ),
                      ),
                    ),
                ],
